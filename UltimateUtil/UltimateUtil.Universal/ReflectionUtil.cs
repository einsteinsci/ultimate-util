...
namespace UltimateUtil
{
	...
	public static class ReflectionUtil
	{
		...
		{
			return tested.GetCustomAttributes(attribute, false).Count() > 0;
		}
		/// <summary>
		/// Returns whether a member has a given attribute
		/// </summary>
		...
		{
			return tested.GetTypeInfo().GetCustomAttributes(attribute, false).Count() > 0;
		}
		/// <summary>
		/// Returns whether a member has a given attribute
		/// </summary>
		...
		/// <c>false</c> if not
		/// </returns>
		public static bool HasAttribute<TAtt>(this Type tested) where TAtt : Attribute
		{
			return tested.HasAttribute(typeof(TAtt));
		}
		...
		/// </exception>
		public static List<MemberInfo> GetMembersWithAttribute(this Type type, Type att)
		{
		...
		/// applied to them
		/// </returns>
		public static List<MemberInfo> GetMembersWithAttribute<TAtt>(this Type type)
			where TAtt : Attribute
		{
			return type.GetMembersWithAttribute(typeof(TAtt));
		}
